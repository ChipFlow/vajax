...
Usage:
    from jax_spice.benchmarks.registry import discover_benchmarks, BENCHMARKS
...
ADDITIONAL_BENCHMARKS_DIR = PROJECT_ROOT / "jax_spice" / "benchmarks" / "data"
...
def discover_benchmarks(benchmark_dir: Optional[Path] = None) -> Dict[str, BenchmarkInfo]:
    ...
    2. jax_spice/benchmarks/data/*/*.sim
    ...
    # Discover additional benchmarks from jax_spice/benchmarks/data/
