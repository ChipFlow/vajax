...
def dc_operating_point_analytical(
    ...
    """Find DC operating point using analytical Jacobians from OpenVAF.
    ...
    from jax_spice.analysis.solver import solve_dc_with_builder
    ...
    with jax.default_device(device):
        ...
        result = solve_dc_with_builder(builder, V_init, config)
