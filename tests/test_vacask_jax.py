...
class TestResistorSim:
    ...
    def sim_data(self):
        ...
        return {"circuit": circuit, "module": modules[0], "eval_fn": eval_fn, "sim_path": sim_path}
...
class TestCapacitorSim:
    ...
    def sim_data(self):
        ...
        return {"circuit": circuit, "module": modules[0], "eval_fn": eval_fn}
    ...
    def test_parses_correctly(self, sim_data):
        ...
        c_inst = next(
            (
                i
                for i in circuit.top_instances
                if "capacitor" in i.model.lower() or i.name.startswith("c")
            ),
            None,
        )
